import { defineComponent, Transition, ref, shallowRef, onMounted, withModifiers } from 'vue'
    ...
    return () => (
      <Transition name="van-fade">
        {visible.value ? (
          ...
          >
            {slots.default ? slots.default() : <Button type="primary" icon="back-top" round vlib-back-top-tsx />}
          </div>
        ) : null}
      </Transition>
    )
